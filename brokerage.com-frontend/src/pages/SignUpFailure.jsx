...
const SignUpFailure = () => {
  return (
    <div>
        ...
        <Link className='text-violet-700 hover:text-violet-500 px-4 py-3 rounded-lg transition' to='/signup'>Try Signing Up <span className='text-gray-400'>again</span> &#128522;</Link>
        </div>
    </div>
  )
}
